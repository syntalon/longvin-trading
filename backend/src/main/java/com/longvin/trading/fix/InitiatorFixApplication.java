...
@Component
public class InitiatorFixApplication implements Application {

    private static final String CONNECTION_TYPE = "initiator";

    private final OrderReplicationCoordinator coordinator;
    private final FixSessionRegistry sessionRegistry;

    public InitiatorFixApplication(OrderReplicationCoordinator coordinator,
